...
type Options = {
	 ...
	 *
	 * Enabling this will only evalulate expressions defined in the same file, which works well for simple cases.
	 * Note that if you are trying to interpolate class names generated by ecsstatic, you currently need to make sure
	 * they're assigned to a top-level variable (vs inside a function or object).
	 *
